    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialogConf.setNeutralButton("dismiss",
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        myToast.makeText(myContext, "dismiss", Toast.LENGTH_LONG).show();
                    }
                });
        ...
        dialogConf.setNegativeButton("No",
                new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        myToast.makeText(myContext, "No", Toast.LENGTH_LONG).show();
                    }
                });
        ...
        dialogConf.setPositiveButton("Yes",
                new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        myToast.makeText(myContext, "Yes", Toast.LENGTH_LONG).show();
                    }
                });
